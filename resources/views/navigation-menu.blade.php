<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @hasanyrole('super-admin|admin')
                        ...
                        <x-nav-link href="{{ route('admin.shopping-lists.index') }}" :active="request()->routeIs('admin.shopping-lists.*')">
                            {{ __('Shopping Lists') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('website.home') }}" :active="request()->routeIs('website.*')">
                {{ __('Website') }}
            </x-responsive-nav-link>
            @hasanyrole('super-admin|admin')
                ...
                <x-responsive-nav-link href="{{ route('admin.shopping-lists.index') }}" :active="request()->routeIs('admin.shopping-lists.*')">
                    {{ __('Shopping Lists') }}
                </x-responsive-nav-link>
